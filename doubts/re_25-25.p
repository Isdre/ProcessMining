...
fof(rule60, axiom, ![X1]: ((tau(X1)) => ?[X0]: (repair_complex(X0)))).
fof(rule61, axiom, ![X1]: ((a2_s(X1)) => (?[X0]: (x2_s(X0) | x2_e(X0)) & ?[X2]: (l_s(X2) | test_repair(X2))))).
fof(rule62, axiom, ![X0]: (~((l_s(X0)) & (repair_complex(X0))))).
fof(rule63, axiom, ![X1]: ((x2_s(X1)) => ((?[X0]: (tau(X0)) & ~(?[X2]: (repair_simple(X2)))) | (~(?[X3]: (tau(X3))) & ?[X4]: (repair_simple(X4)))))).
fof(rule64, axiom, ![X0]: (~((inform_user(X0)) & (x2_e(X0))))).
fof(rule65, axiom, ![X0]: (~((tau(X0)) & (x2_e(X0))))).
fof(rule66, axiom, ![X1]: ((restart_repair(X1)) => ?[X0]: (x2_s(X0) | test_repair(X0)))).
fof(rule67, axiom, ![X0]: (~((repair_simple(X0)) & (x2_e(X0))))).
fof(rule68, axiom, ![X1]: ((l_s(X1) | test_repair(X1)) => ?[X0]: (a2_e(X0)))).
fof(rule69, axiom, ![X0]: (~(((x2_s(X0) | x2_e(X0)) | (a2_s(X0) | a2_e(X0))) & (a2_e(X0))))).
fof(rule70, axiom, ![X0]: (~((x2_s(X0) | x2_e(X0)) & (test_repair(X0))))).
fof(rule71, axiom, ![X1]: ((a2_s(X1)) => (?[X0]: (x2_s(X0) | x2_e(X0)) & ?[X2]: (a2_s(X2) | a2_e(X2))))).
fof(rule72, axiom, ![X0]: (~((analyze_defect(X0)) & (end(X0))))).
fof(rule73, axiom, ![X0]: (~((l_s(X0) | repair_complex(X0)) & (x2_e(X0))))).
fof(rule74, axiom, ![X0]: (~((tau(X0)) & (inform_user(X0))))).
fof(rule75, axiom, ![X0]: (~((register(X0)) & (end(X0))))).
fof(rule76, axiom, ![X1]: ((x2_s(X1) | x2_e(X1)) => ?[X0]: (test_repair(X0)))).
fof(rule77, axiom, ![X0]: (~((x2_s(X0)) & (l_s(X0) | repair_complex(X0))))).
fof(rule78, axiom, ![X1]: (((tau(X1)) | (l_s(X1) | repair_complex(X1))) => ?[X0]: (x2_e(X0)))).
fof(rule79, axiom, ![X1]: ((l_s(X1)) => ?[X0]: (x2_s(X0) | test_repair(X0)))).
fof(rule80, axiom, ![X1]: ((a2_s(X1) | a2_e(X1)) => ?[X0]: (archive_repair(X0)))).
fof(rule81, axiom, ![X1]: ((x2_s(X1)) => ((?[X0]: (tau(X0)) & ~(?[X2]: (inform_user(X2)))) | (~(?[X3]: (tau(X3))) & ?[X4]: (inform_user(X4)))))).
fof(rule82, axiom, ![X0]: (~((x2_s(X0)) & (inform_user(X0))))).
fof(rule83, axiom, ![X1]: (((tau(X1)) | (inform_user(X1))) => ?[X0]: (x2_e(X0)))).
fof(rule84, axiom, ![X1]: ((archive_repair(X1)) => ?[X0]: (end(X0)))).
fof(rule85, axiom, ![X0]: (~((x2_s(X0)) & (tau(X0))))).
fof(rule86, axiom, ![X0]: (~((analyze_defect(X0)) & (a2_s(X0) | a2_e(X0))))).
fof(rule87, axiom, ![X1]: ((x2_s(X1)) => ((?[X0]: (tau(X0)) & ~(?[X2]: (l_s(X2) | repair_complex(X2)))) | (~(?[X3]: (tau(X3))) & ?[X4]: (l_s(X4) | repair_complex(X4)))))).
fof(rule88, axiom, ![X0]: (~((analyze_defect(X0)) & (archive_repair(X0))))).
fof(rule89, axiom, ![X0]: (~((tau(X0)) & (l_s(X0) | repair_complex(X0))))).
fof(rule90, axiom, ![X0]: (~((x2_s(X0)) & (repair_simple(X0))))).
fof(rule91, axiom, ![X0]: (~((l_s(X0)) & (restart_repair(X0))))).
fof(rule92, axiom, ?[X0]: (a2_s(X0))).
fof(rule93, axiom, ![X0]: (~((tau(X0)) & (repair_simple(X0))))).
fof(rule94, axiom, ?[X0]: (l_s(X0))).
fof(rule95, axiom, ![X0]: (~((a2_s(X0)) & ((x2_s(X0) | x2_e(X0)) | (l_s(X0) | test_repair(X0)))))).
fof(rule96, axiom, ![X0]: (~((a2_s(X0) | a2_e(X0)) & (archive_repair(X0))))).
fof(rule97, axiom, ![X1]: ((a2_s(X1) | a2_e(X1)) => ?[X0]: (a2_e(X0)))).
fof(rule98, axiom, ![X0]: (~((register(X0)) & (a2_s(X0) | a2_e(X0))))).
fof(rule99, axiom, ![X0]: (~((x2_s(X0) | test_repair(X0)) & (restart_repair(X0))))).
fof(rule100, axiom, ![X0]: (~((repair_complex(X0)) & (tau(X0))))).
fof(rule101, axiom, ![X1]: ((l_s(X1)) => ?[X0]: (repair_complex(X0)))).
fof(rule102, axiom, ?[X0]: (register(X0))).
fof(rule103, axiom, ![X0]: (~((a2_s(X0) | a2_e(X0)) & (end(X0))))).
fof(rule104, axiom, ![X0]: (~((a2_s(X0)) & ((x2_s(X0) | x2_e(X0)) | (a2_s(X0) | a2_e(X0)))))).
fof(rule105, axiom, ![X0]: (~((archive_repair(X0)) & (end(X0))))).
...
fof(rule110, axiom, ![X1]: ((x2_s(X1) | test_repair(X1)) => ((?[X0]: (restart_repair(X0)) & ?[X2]: (x2_s(X2) | test_repair(X2))) | (~(?[X3]: (restart_repair(X3))))))).
fof(rule111, axiom, ![X1]: (((tau(X1)) | (repair_simple(X1))) => ?[X0]: (x2_e(X0)))).
fof(rule112, axiom, ![X1]: ((register(X1)) => ?[X0]: (analyze_defect(X0)))).
fof(rule113, axiom, ![X0]: (~((l_s(X0)) & (x2_s(X0) | test_repair(X0))))).
...
fof(rule117, axiom, ?[X0]: (x2_s(X0))).
fof(rule118, axiom, ![X0]: (~((l_s(X0)) & (tau(X0))))).
fof(rule119, axiom, ![X0]: (~((register(X0)) & (analyze_defect(X0))))).
